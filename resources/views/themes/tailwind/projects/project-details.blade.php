...
<div class="flex justify-end items-center">
    <div class="">
        <button type="button" data-modal-target="download-document-modal" data-modal-toggle="download-document-modal" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-brand-800 dark:hover:bg-brand-700 dark:focus:ring-brand-700 brandDark2">
            ...
            <div class="px-6 py-10 lg:px-8">
                <div class="space-y-6">
                    ...
                    <div class="dark:text-white text-center">
                        ...
                        <h3 class="my-5 dark:color-white color-black" style="font-size: 24px; font-weight: 500; overflow-wrap: break-word;"> Your project is Completed </h3>
                    ...
                    <div class="dark:text-white text-center">
                        ...
                        <h3 class="my-5 dark:color-white color-black" style="font-size: 24px; font-weight: 500; overflow-wrap: break-word;"> Your project is incomplete </h3>
