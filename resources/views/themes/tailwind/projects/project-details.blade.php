            ...
            <div class="px-6 py-10 lg:px-8">
                <div class="space-y-6">
                    ...
                    <div class="dark:text-white text-center">
                        ...
                        <h3 class="my-5" style="color: white; font-size: 24px; font-weight: 500; overflow-wrap: break-word;"> Your project is Completed </h3>
                    ...
                    <div class="dark:text-white text-center">
                        ...
                        <h3 class="my-5" style="color: white; font-size: 24px; font-weight: 500; overflow-wrap: break-word;"> Your project is incomplete </h3>
