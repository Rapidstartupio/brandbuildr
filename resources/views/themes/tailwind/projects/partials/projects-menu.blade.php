<ul class="flex flex-wrap -mb-px text-lg">
    ...
    <li class="mr-10">
        <a href="#" class="inline-block py-2 border-b-2 rounded-t-lg @if(Request::is('projects/project-types')) border-white active dark:text-white dark:border-white @else border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 @endif">Project Types</a>
    </li>
</ul>