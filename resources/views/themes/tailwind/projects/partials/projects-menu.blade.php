<ul class="flex flex-wrap -mb-px text-lg">
    <li class="mr-10">
        <a href="{{route('projects.index')}}" class="inline-block py-2 border-b-2 rounded-t-lg @if(Request::is('projects')) border-white active dark:text-white dark:border-white @else border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 @endif" aria-current="page">Strategies</a>
    </li>
    <li class="mr-10">
    ...
    <li class="mr-10">
        <a href="{{route('projects.deadlines')}}" class="inline-block py-2 border-b-2 rounded-t-lg @if(Request::is('projects/deadlines')) border-white active dark:text-white dark:border-white @else border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 @endif">Deadlines</a>
    </li>
