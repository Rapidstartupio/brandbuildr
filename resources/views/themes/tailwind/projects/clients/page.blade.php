...
<div class="text-white">
    ...
    <div class="grid sm:grid-cols-6 pt-6">
        <div class="sm:border-r border-gray-600 pr-3 col-span-2 lg:col-span-1 break-words">
                ...
                <ol class="text-base py-6 space-y-4">
                    ...
                    <li>
                        <div class="flex font-light justify-between">
                            ...
                            <div>{{$inProgressProjectsCount}}</div>
                        </div>
                    </li>
                    <li>
                        <div class="flex font-light justify-between">
                            ...
                            <div>{{$completedProjectsCount}}</div>
                        </div>
                    </li>
                </ol>
            </div>
        ...
        <div class="col-span-4 lg:col-span-5 sm:pl-4">
            <div class="flex justify-between items-center">
                ...
                <div class="">
                    <a href="{{route('clients.edit',$client->id)}}" class="flex md:float-right text-white bg-blue-700  hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-wave-500 dark:hover:bg-wave-700 focus:outline-none dark:focus:ring-blue-800 space-x-1">
                        <span>
                    ...
                    <a href="{{route('projects.create')}}" class=" md:float-right text-white bg-blue-700  hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-wave-500 dark:hover:bg-wave-700 focus:outline-none dark:focus:ring-blue-800 flex space-x-1">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
