...
<div class="py-20 pricing-page">
    <div class="sm:mx-auto sm:w-full sm:max-w-5xl">
        ...
        <p class="max-w-md mx-auto mt-4 text-lg text-gray-500 lg:max-w-none lg:text-xl sm:text-center"><a href="https://brandbuildr.ai/pricing"><< Back to Pricing Options</a></p>
