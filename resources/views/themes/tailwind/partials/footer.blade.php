<!-- Section 1 -->
<footer class="@if(Request::is('/')){{ 'bg-white' }}@else{{ 'bg-gray-50' }}@endif bg-white dark:bg-black dark:text-white home-footer">
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-wrap items-start justify-between pb-20">
            ...
            <div class="grid w-full grid-cols-1 pt-2 mt-20 sm:grid-cols-3 gap-y-16 lg:gap-x-8 md:w-5/6 md:mt-0 md:pr-6">
                ...
                <div class="md:justify-self-end">
                    <h3 class="font-semibold text-black dark:text-white">CONTACTS</h3>
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="#_" class="flex items-center text-black dark:text-white group">
                                <!-- Icon -->
                                <span class="w-5 h-5 mr-2 text-gray-600 dark:text-gray-400">
                ...
                <div class="md:justify-self-end">
                    <h3 class="font-semibold text-black dark:text-white">NEWSLETTER</h3>
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0"> {{ setting('site.title', 'Laravel Wave') }} &copy; {{ date('Y') }}. All rights reserved.</li>
                <li class="lg:ml-6">
                    <a href="https://brandbuildr.ai/privacy-policy/" target="_blank" class="relative inline-block text-black dark:text-white group">
                ...
                <li class="ml-auto mr-auto text-center lg:ml-6 lg:mr-0">
                    <a href="https://brandbuildr.ai/beta-nda/" target="_blank" class="relative inline-block text-black dark:text-white group">
                        <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-0"></span>
                        <span>Non-Disclosure Agreement</span>
                    </a>
                </li>
                <li class="lg:ml-6">
                    <a href="https://brandbuildr.ai/terms-conditions/" target="_blank" class="relative inline-block text-black dark:text-white group">
                        <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-0"></span>
...
<!-- Scripts -->
<script src="{{ asset('themes/' . $theme->folder . '/js/app.js?1') }}"></script>
