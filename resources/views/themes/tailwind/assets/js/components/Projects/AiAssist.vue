                    ...
                    <div id="myTabContent" class=" ">
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="text-center" v-if="aiUsage.allowed">
                                    <a class="bg-brand-900 p-2 rounded-lg text-wave-500">{{ aiUsage.count + "/"+aiUsage.allowed }}</a>
                                </div>
                                <div class="pt-10">
                                    <svg
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        if (botResponse) {
                            ...
                            //console.log(this.steps[this.step].suggest_logs);
                            this.isLoading = false;
                            if(response.data.ai_ussage){
                                this.aiUsage.count = response.data.ai_ussage.userAiSuggestUssageCount+1;
                                this.aiUsage.allowed = response.data.ai_ussage.maxAiSuggestUssageAllowed;
                            }
                        }
                    })
                    .catch((error) => {
                        ...
                        if(error.response.data.ai_ussage){
                            this.aiUsage.count = error.response.data.ai_ussage.userAiSuggestUssageCount;
                            this.aiUsage.allowed = error.response.data.ai_ussage.maxAiSuggestUssageAllowed;
                        }
                        //console.log(error);
                        //console.error("Error fetching bot response:", error);
                    });
