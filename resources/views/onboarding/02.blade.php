...
@section('content')
    <div class="py-20 mx-auto max-w-7xl">
       ...
       <div class="w-[1262px] h-[518px] relative bg-white bg-opacity-10 rounded-[15px]">
          ...
          <div class="w-[400px] h-[3px] left-0 top-[56px] absolute bg-wave-500"></div>
          ...
          <div class="left-[54px] top-[146px] absolute flex-col justify-start items-center gap-14 inline-flex">
            <div class="flex-col justify-start items-center gap-3 flex">
              <div class="w-[550px] text-center text-white text-xl font-medium">What problems / challenges do you help to solve?</div>
            ...
            <div class="self-stretch grow shrink basis-0 flex-col justify-start items-start gap-4 flex">
              <div style="width: -webkit-fill-available;">
                ...
                <input type="text" id="business_description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Being able to feed large groups without the associated problems" required>

                <div class="self-stretch h-[0px] border border-white"></div>
              </div>
           
              <div class="flex">
                <a href="{{route('dashboard-onboarding','03')}}">
                ...
                <a href="{{route('dashboard-onboarding','01')}}">
                  <div class="w-[50px] h-5 rounded-lg shadow justify-center items-center gap-2.5 inline-flex">
                    <div class="text-center text-blue-50 text-base font-medium underline leading-tight">Back</div>
                  </div>
                </a>
              </div>
            </div>
