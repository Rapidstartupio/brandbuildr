...
@section('content')
    <div class="py-20 mx-auto max-w-7xl">
       ...
       <div class="w-[1262px] h-[518px] relative bg-white bg-opacity-10 rounded-[15px]">
          ...
          <div class="w-[659px] h-[3px] left-0 top-[56px] absolute bg-wave-500"></div>
          ...
          <div class="left-[54px] top-[146px] absolute flex-col justify-start items-center gap-14 inline-flex">
            <div class="flex-col justify-start items-center gap-3 flex">
              <div class="w-[550px] text-center text-white text-xl font-medium">Who typically has these challenges?</div>
              <div class="w-[550px] text-center text-white text-sm font-light">Your previous answers should act as the seed</div>
            </div>
