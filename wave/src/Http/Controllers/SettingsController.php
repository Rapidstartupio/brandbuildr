...
class SettingsController extends Controller
{
    ...
    public function profilePut(Request $request)
    {
        ...
        $authed_user->phone_number = $request->phone_number;
        $authed_user->position = $request->position;
        $authed_user->company_name = $request->company_name;
        $authed_user->owner = $request->owner;
        $authed_user->address = $request->address;
        $authed_user->website = $request->website;
        $authed_user->country = $request->country;
        $authed_user->city = $request->city;
        $authed_user->street = $request->street;
        $authed_user->zip_code = $request->zip_code;
